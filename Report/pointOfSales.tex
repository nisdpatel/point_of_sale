...
We have modified the previous interface with this one because navigating from one window to the another until you reach the final sub menu was bit challenging. We decided to go with a simple option where our design looks simple and easy to implement.
